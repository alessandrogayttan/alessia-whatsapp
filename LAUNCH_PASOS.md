...
Código listo con: ack inmediato, cola SQLite de mensajes, reintentos WhatsApp, health `/health/ready` + `/health/metrics`, volumen persistente, backup automático DB, CI GitHub Actions, ARCO completo, facturación CFDI, pagos cita online, escalaciones con re-aviso, sync web diario, Sentry opcional.
